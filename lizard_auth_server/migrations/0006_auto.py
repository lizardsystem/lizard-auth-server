...
class Migration(SchemaMigration):
    ...
    models = {
        ...
        u'lizard_auth_server.organisation': {
            ...
            'unique_id': ('django.db.models.fields.CharField', [], {'default': "'9af7d6620cd5429882667e9ce437e66d'", 'unique': 'True', 'max_length': '32'})
        },
        ...
        u'lizard_auth_server.portal': {
            ...
            'sso_key': ('django.db.models.fields.CharField', [], {'default': "u'fyQkPyODyBcvvCChQjFndFaEg4si8UDS7ma3GGSxD4uqeujkkqzOdyMHqaRETyd6'", 'unique': 'True', 'max_length': '64'}),
            'sso_secret': ('django.db.models.fields.CharField', [], {'default': "u'Yz7wd6lNnomYT9yYwZNJ67OJcteNwhu9H7PH51nwdcllojO531fXEUlb5iPmMoG8'", 'unique': 'True', 'max_length': '64'}),
        ...
        u'lizard_auth_server.role': {
            ...
            'child_roles': ('django.db.models.fields.related.ManyToManyField', [], {'symmetrical': 'False', 'related_name': "u'parent_roles'", 'blank': 'True', 'to': u"orm['lizard_auth_server.Role']"}),
            ...
            'unique_id': ('django.db.models.fields.CharField', [], {'default': "'80cb3a4f54414a57b220000a30187382'", 'unique': 'True', 'max_length': '32'})
        },
        u'lizard_auth_server.token': {
            ...
            'created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 11, 10, 0, 0)'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
