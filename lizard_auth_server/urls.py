...
urlpatterns = [
    ...
    url(
        r"^api2/logout_redirect_back_to_portal/$",
    ...
    url(r"^jwt/$", views.JWTView.as_view(), name="lizard_auth_server.jwt"),
